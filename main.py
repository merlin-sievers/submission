...
# # option.add(angr.sim_options.ZERO_FILL_UNCONSTRAINED_MEMORY)
# # option.add(angr.sim_options.ZERO_FILL_UNCONSTRAINED_REGISTERS)
...
#
# #
# project = angr.Project("Testsuite/MAGMA/openssl/vuln/libcrypto.so.3", auto_load_libs=False)
# projec2t = angr.Project("Testsuite/MAGMA/openssl/vuln/libssl.so.3", auto_load_libs= False)


# # Getting the target function
#
# file_to_be_patched = SectionExtender("Testsuite/MAGMA/openssl/vuln/libcrypto.so.3",  0).extend_last_section_of_segment()
#
#
# backend = DetourBackend("Testsuite/MAGMA/libxml/vuln/libxml2.so.2.9.12")
# patches = []
...
#
# test = project.kb.cfgs.cfgs["CFGEmulated"].project.factory.block(target_function.rebased_addr)
#
# node = cfg.get_all_nodes(target_function.rebased_addr)
#
