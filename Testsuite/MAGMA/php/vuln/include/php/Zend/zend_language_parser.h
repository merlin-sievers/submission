...
#ifndef YY_ZEND_HOME_JAENICH_MAGMA_MAGMA_TARGETS_PHP_REPO_ZEND_ZEND_LANGUAGE_PARSER_H_INCLUDED
# define YY_ZEND_HOME_JAENICH_MAGMA_MAGMA_TARGETS_PHP_REPO_ZEND_ZEND_LANGUAGE_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef ZENDDEBUG
# if defined YYDEBUG
#if YYDEBUG
...
#line 41 "/home/jaenich/Magma/magma/targets/php/repo/Zend/zend_language_parser.y"

#include "zend_compile.h"

#line 61 "/home/jaenich/Magma/magma/targets/php/repo/Zend/zend_language_parser.h"
...
# define ZENDTOKENTYPE
  enum zendtokentype
  {
    ...
    T_ENUM = 335,                  /* "'enum'"  */
    T_EXTENDS = 336,               /* "'extends'"  */
    T_IMPLEMENTS = 337,            /* "'implements'"  */
    T_NAMESPACE = 338,             /* "'namespace'"  */
    T_LIST = 339,                  /* "'list'"  */
    T_ARRAY = 340,                 /* "'array'"  */
    T_CALLABLE = 341,              /* "'callable'"  */
    T_LINE = 342,                  /* "'__LINE__'"  */
    T_FILE = 343,                  /* "'__FILE__'"  */
    T_DIR = 344,                   /* "'__DIR__'"  */
    T_CLASS_C = 345,               /* "'__CLASS__'"  */
    T_TRAIT_C = 346,               /* "'__TRAIT__'"  */
    T_METHOD_C = 347,              /* "'__METHOD__'"  */
    T_FUNC_C = 348,                /* "'__FUNCTION__'"  */
    T_NS_C = 349,                  /* "'__NAMESPACE__'"  */
    T_ATTRIBUTE = 350,             /* "'#['"  */
    T_PLUS_EQUAL = 351,            /* "'+='"  */
    T_MINUS_EQUAL = 352,           /* "'-='"  */
    T_MUL_EQUAL = 353,             /* "'*='"  */
    ...
    T_SL_EQUAL = 360,              /* "'<<='"  */
    T_SR_EQUAL = 361,              /* "'>>='"  */
    T_COALESCE_EQUAL = 362,        /* "'??='"  */
    T_BOOLEAN_OR = 363,            /* "'||'"  */
    T_BOOLEAN_AND = 364,           /* "'&&'"  */
    T_IS_EQUAL = 365,              /* "'=='"  */
    T_IS_NOT_EQUAL = 366,          /* "'!='"  */
    T_IS_IDENTICAL = 367,          /* "'==='"  */
    T_IS_NOT_IDENTICAL = 368,      /* "'!=='"  */
    T_IS_SMALLER_OR_EQUAL = 369,   /* "'<='"  */
    T_IS_GREATER_OR_EQUAL = 370,   /* "'>='"  */
    T_SPACESHIP = 371,             /* "'<=>'"  */
    T_SL = 372,                    /* "'<<'"  */
    T_SR = 373,                    /* "'>>'"  */
    T_INC = 374,                   /* "'++'"  */
    T_DEC = 375,                   /* "'--'"  */
    T_INT_CAST = 376,              /* "'(int)'"  */
    T_DOUBLE_CAST = 377,           /* "'(double)'"  */
    T_STRING_CAST = 378,           /* "'(string)'"  */
    T_ARRAY_CAST = 379,            /* "'(array)'"  */
    T_OBJECT_CAST = 380,           /* "'(object)'"  */
    T_BOOL_CAST = 381,             /* "'(bool)'"  */
    T_UNSET_CAST = 382,            /* "'(unset)'"  */
    T_OBJECT_OPERATOR = 383,       /* "'->'"  */
    T_NULLSAFE_OBJECT_OPERATOR = 384, /* "'?->'"  */
    T_DOUBLE_ARROW = 385,          /* "'=>'"  */
    T_COMMENT = 386,               /* "comment"  */
    T_DOC_COMMENT = 387,           /* "doc comment"  */
    T_OPEN_TAG = 388,              /* "open tag"  */
    T_OPEN_TAG_WITH_ECHO = 389,    /* "'<?='"  */
    T_CLOSE_TAG = 390,             /* "'?>'"  */
    T_WHITESPACE = 391,            /* "whitespace"  */
    T_START_HEREDOC = 392,         /* "heredoc start"  */
    T_END_HEREDOC = 393,           /* "heredoc end"  */
    T_DOLLAR_OPEN_CURLY_BRACES = 394, /* "'${'"  */
    T_CURLY_OPEN = 395,            /* "'{$'"  */
    T_PAAMAYIM_NEKUDOTAYIM = 396,  /* "'::'"  */
    T_NS_SEPARATOR = 397,          /* "'\\'"  */
    T_ELLIPSIS = 398,              /* "'...'"  */
    T_COALESCE = 399,              /* "'??'"  */
    T_POW = 400,                   /* "'**'"  */
    T_POW_EQUAL = 401,             /* "'**='"  */
    T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG = 402, /* "'&'"  */
    T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG = 403, /* "amp"  */
    T_BAD_CHARACTER = 404,         /* "invalid character"  */
    T_ERROR = 405                  /* T_ERROR  */
  };
...
#endif /* !YY_ZEND_HOME_JAENICH_MAGMA_MAGMA_TARGETS_PHP_REPO_ZEND_ZEND_LANGUAGE_PARSER_H_INCLUDED  */
