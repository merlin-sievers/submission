...
export LD_LIBRARY_PATH=/home/jaenich/Libraries/libjpeg-turbo-2.0.3:/home/jaenich/Magma/magma/targets/libxml2/repo/vuln/lib/:/usr/local/lib/zlib/lib/:/home/jaenich/Libraries/lib

# Set the path to the fuzzer binary
fuzzer_binary="./libxml2_xml_read_memory_fuzzer"
...
output=$("$fuzzer_binary" < "$input_file" 2>&1)
        echo "$output"
        ...
        if [[ $output == *"REACHED"* && $output == *"E"* ]]; then
            ...
            export LD_LIBRARY_PATH=/home/jaenich/Libraries/libjpeg-turbo-2.0.3:/home/jaenich/Magma/magma/targets/libxml2/repo/fixed/lib:/usr/local/lib/zlib/lib/:/home/jaenich/Libraries/lib
            output=$("$fuzzer_binary" < "$input_file" 2>&1)
