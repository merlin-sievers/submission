...
l = logging.getLogger("patcherexMM.test.test_techniques_detourbackend")
...
./cgc_configure_debug
make -j4
cp i386-linux-user/qemu-i386 <patcherexMM>/tests/old_tracer-qemu-cgc
'''
...
if __name__ == "__main__":
    import sys
    logging.getLogger("patcherexMM.test.test_techniques").setLevel("INFO")
    logging.getLogger("patcherexMM.backends.DetourBackend").setLevel("INFO")
    logging.getLogger("patcherexMM.backends.reassembler_backend").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.Backdoor").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.ShadowStack").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.SimpleCFI").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.QemuDetection").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.StackRetEncryption").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.IndirectCFI").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.TransmitProtection").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.Adversarial").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.NxStack").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.ShiftStack").setLevel("DEBUG")
    logging.getLogger("patcherexMM.techniques.Countdown").setLevel("DEBUG")
