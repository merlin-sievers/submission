...
l = logging.getLogger("patcherexMM.PatchMaster")
...
if __name__ == "__main__":
    if sys.argv[1] == "run":
        ...
        logging.getLogger("patcherexMM.backend").setLevel("INFO")
        logging.getLogger("patcherexMM.techniques.NoFlagPrintfPatcher").setLevel("DEBUG")
        ...
        logging.getLogger("patcherexMM.PatchMaster").setLevel("INFO")
