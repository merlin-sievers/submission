...
class Patching:
    ...
    def patch(self, binary_fname):
        ...
        jump_back_address = min([match for match in perfect_matches.match_old_address if match > self.code_block_end.addr])
        ...
        self.indirection_address = start_address_of_patch + 8
